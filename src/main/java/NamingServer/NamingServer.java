...
public class NamingServer {
    ...
    public static void main(String[] args) {
        ...
        Replyer r = new Replyer("da",new AddressImpl("NamingServer", 1234)); /*adresa hardcodata (numele(destinatina) nu conteaza pentru replyer, o sa se faca un server socket
